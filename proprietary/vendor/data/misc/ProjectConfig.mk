...
AUTO_ADD_GLOBAL_DEFINE_BY_VALUE = CUSTOM_TRAN_PROJECT CUSTOM_TRAN_BOM  CUSTOM_TRAN_PCBA CUSTOM_TRAN_CAM_MATERIAL_CODE BOOT_LOGO MTK_PLATFORM CUSTOM_KERNEL_MAIN_IMGSENSOR MTK_BT_CHIP MTK_WLAN_CHIP CUSTOM_KERNEL_MAIN_BACKUP_IMGSENSOR CUSTOM_KERNEL_FLASHLIGHT CUSTOM_KERNEL_SUB_IMGSENSOR CUSTOM_KERNEL_IMGSENSOR MTK_FM_RX_AUDIO MTK_COMBO_CHIP MTK_GPS_CHIP CUSTOM_KERNEL_MAIN2_IMGSENSOR BOOT_LOGO
#BSP: modify P1 porting CDQHLEYSSS-3 by baofu.zhang 20190923 start
BOOT_LOGO = hdplus1600
#BSP: modify P1 porting CDQHLEYSSS-3 by baofu.zhang 20190923 end
BUILD_AGO_GMS = no
BUILD_KERNEL = yes
BUILD_LK = yes
BUILD_MD32 = no
BUILD_PRELOADER = yes
#BSP: add custom macro by wanghanfeng 20190922 start
CUSTOM_BUILD_VERNO = CY-X655F-H6211-E
#BSP: add custom macro by wanghanfeng 20190922 end
...
CUSTOM_TRAN_PCBA = tran_pcba_h6211
MTK_CAM_MAX_NUMBER_OF_CAMERA = 5
TRAN_CAMERA_FAKE_STEREO_YUV_INDEX=4
TRAN_CAMERA_FAKE_STEREO_SAME_CLK_WITH_MAIN = yes
CUSTOM_HAL_IMGSENSOR = ov48b2q_mipi_raw gc8034_mipi_raw gc2375h_mipi_raw gc2375hmain3_mipi_raw gc6153_serial_yuv pblcov48b2q_mipi_raw pblcgc8034_mipi_raw pblcgc2375h_mipi_raw pblcgc2375hmain3_mipi_raw pblcgc6153_serial_yuv
CUSTOM_TRAN_CAM_MATERIAL_CODE = ov48b2q_17201612 gc8034_17201572 gc2375h_17201598 gc2375h_17201597 gc6153_17201581
CUSTOM_HAL_MAIN_IMGSENSOR = ov48b2q_mipi_raw
CUSTOM_HAL_MAIN2_IMGSENSOR = gc2375h_mipi_raw
CUSTOM_TRAN_HAL_MAIN3_IMGSENSOR = gc2375hmain3_mipi_raw
CUSTOM_TRAN_HAL_MAIN4_IMGSENSOR = gc6153_serial_yuv
#BSP: add BLSLEPUB-3246 by zhigang.yang for 20191113 start
CUSTOM_HAL_MSENSORLIB = mmc5603_x655f
#BSP: add BLSLEPUB-3246 by zhigang.yang for 20191113 end
...
#BSP: add BLSLEPUB-4 by zhigang.yang for 20191009 start
CUSTOM_KERNEL_ANSWER_CALL_SENSOR = no
CUSTOM_KERNEL_BAROMETER = no
#BSP: add BLSLEPUB-4 by zhigang.yang for 20191009 end
...
#BSP: add BLSLEPUB-4 by zhigang.yang for 20191009 end
#ITD:modify by camera driver team start
CUSTOM_KERNEL_IMGSENSOR = ov48b2q_mipi_raw gc8034_mipi_raw gc2375h_mipi_raw gc2375hmain3_mipi_raw gc6153_serial_yuv
#ITD:modify by camera driver team end
...
CUSTOM_KERNEL_MAIN_IMGSENSOR = ov48b2q_mipi_raw
#ITD:modify by camera driver team end
...
#BSP: add for cv SIGNIFICANT_MOTION test fail BLSLEPUB-1883 by zhigang.yang for 20191031 start
CUSTOM_KERNEL_SIGNIFICANT_MOTION_SENSOR = no
#BSP: add for cv SIGNIFICANT_MOTION test fail BLSLEPUB-1883 by zhigang.yang for 20191031 end
...
#TSD: modify BLSLEPUB-2 by baoxin.he 20190929 start
CUSTOM_MODEM=x655c_h6211_a1
#TSD: modify BLSLEPUB-2 by baoxin.he 20190929 end
...
# BSP:modify BLSLEPUB-1 by yong.guo 20190929 start
MTK_AUDIO_NUMBER_OF_MIC = 1
# BSP:modify BLSLEPUB-1 by yong.guo 20190929 end
...
#ITD:off mtk HDR by yu.wang start
MTK_CAM_HDR_SUPPORT = no
#ITD:off mtk HDR by yu.wang end
...
#SID: add XLLLHLWS-17 by shenjiang.he 19.09.02 start
MTK_CTA_SET = no
#SID: add XLLLHLWS-17 by shenjiang.he 19.09.02 end
MTK_CTA_SUPPORT = no
MTK_CTM_SUPPORT = no
...
#BSP:modify for add x655c Charger function XLWWCAEA-2  by yongxian.wang  20191009 start
MTK_DUAL_CHARGER_SUPPORT = no
TRAN_LED_BLUE_SUPPORT = yes
TRAN_DUAL_LINEAR_CHARGER = yes
#BSP:modify for add x655c Charger function XLWWCAEA-2  by yongxian.wang  20191009 end
...
MTK_FIRST_MD = 1
#TSD: modify BLSLEPUB-2 by baoxin.he 20191011 start
MTK_FLIGHT_MODE_POWER_OFF_MD = no
#TSD: modify BLSLEPUB-2 by baoxin.he 20191011 end
...
MTK_IRTX_SUPPORT = no
# BSP:modify for add Charger function XLWWCAEA-2  by yongxian.wang  20191106 start
MTK_JEITA_STANDARD_SUPPORT = yes
# BSP:modify for add Charger function XLWWCAEA-2  by yongxian.wang  20191106 end
MTK_K64_SUPPORT=yes
...
#BSP: add custom macro by wanghanfeng 20190922 start
CUSTOM_TRAN_PROJECT=tran_x655f
CUSTOM_TRAN_BOM=tran_x655f_e1
#SDD: add XLLLHLWS-17 by shenjiang.he 19.09.02 start
MTK_BUILD_VERNO=X655F-H6211E-Q-200102V108
TRAN_FINGERPRINT_BUILD_VERNO=E-200102V108
#SDD: add XLLLHLWS-17 by shenjiang.he 19.09.02 end
...
#BSP: add custom macro by wanghanfeng 20190922 end
#ITD:add cam 3pty function XLWWCLEYHW-3 by yu.wang 20191017 start
TRAN_CAMERA_FEATURE = yes
TRAN_CAMERA_ANDROID_Q = yes
TRAN_DUALCAM_PICTURESIZE_EXTEND = yes
#ITD:add cam 3pty function XLWWCLEYHW-3 by yu.wang 20191017  end
#ITD: add BLSLEPUB-976 by yang.li3  20191023 start
TRAN_FLASH_SLIDE_CONTROL = yes
#ITD: add BLSLEPUB-976 by yang.li3  20191023 end
###################### ITD Camera Driver start #######################
#ITD: add SKIN by zhoumw 20191106 end
